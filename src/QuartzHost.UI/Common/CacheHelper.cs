...
namespace QuartzHost.UI.Common
{
    public class CacheHelper
    {
        ...
        /// <param name="expiresSliding">滑动过期时长（如果在过期时间内有操作，则以当前时间点延长过期时间）TimeSpan.FromSeconds(22222)</param>
        /// <param name="expiressAbsoulte">绝对过期时长 DateTimeOffset.Now.AddMilliseconds(22222) </param>
        /// <returns></returns>
